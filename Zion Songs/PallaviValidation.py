...
def load_songs(file, lang="telugu"):
    songs = {}
    current_num = None
    current_lines = []
...
telugu_songs = load_songs(telugu_file, "telugu")
english_songs = load_songs(english_file, "english")
...
if missing_report:
    ...
    print("✔ All songs have Pallavi presence aligned between Telugu and English")
